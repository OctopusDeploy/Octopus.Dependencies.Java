...
class Tomcat8ArquillianAPR(testClass: Class<*>?) : Arquillian(testClass) {
    init {
        val options = TomcatHttpsOptions(
                ...
                "Catalina",
                File(Tomcat8ArquillianAPR::class.java.getResource("/octopus.key").file).absolutePath,
                File(Tomcat8ArquillianAPR::class.java.getResource("/octopus.crt").file).absolutePath,
                "",
                "",
                38443,
